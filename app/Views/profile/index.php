          ...
          <div class="x_content">
            <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
              <div class="profile_img">
                <div id="crop-avatar">
                  <!-- Current avatar -->
                  <img class="img-responsive avatar-view" src="<?= base_url('assets/gentelella/images/picture.jpg') ?>" alt="Avatar" title="Change the avatar">
                </div>
              </div>
              <h3>Samuel Doe</h3>
              ...
              <div class="" role="tabpanel" data-example-id="togglable-tabs">
                ...
                <div id="myTabContent" class="tab-content">
                  <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                    ...
                    <ul class="messages">
                      <li>
                        <img src="<?= base_url('assets/gentelella/images/img.jpg') ?>" class="avatar" alt="Avatar">
